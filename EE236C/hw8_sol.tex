...
\usepackage{fancyhdr}\pagestyle{fancy}\rhead{Stephanie Wang}\lhead{EE236C homework 8}
\usepackage{nicefrac}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\noindent1. The Bregman distance generated by the kerneel $\phi(x) = \/1{2t}\|x\|_2^2 - g(x)$ is 
\begin{align*}
  d(x, y) & = \/1{2t}(\|x\|_2^2 - \|y\|_2^2) - g(x) + g(y) - \l(\/1t y - \nabla g(y)\r)^T(x-y) \\
          & = \/1{2t} (\|x\|_2^2 + \|y\|_2^2) - g(x) + g(y) - \/1tx^Ty + \nabla g(y)^T(x-y) \\
          & = \/1{2t}\|x-y\|_2^2 - g(x) + g(y) - \nabla g(y)^T(x-y).
\end{align*}
Substitute $y$ with $x_k$, the proximal point iteration boils down to
\begin{align*}
  x_{k+1} & = \argmin_{x} g(x) + h(x) + \/1{2t}\|x-x_k\|_2^2-g(x)+g(x_k) - \nabla g(x_k)^T(x-x_k) \\
          & = \argmin_x th(x) + \/12\|x-x_k\|_2^2 - t\nabla g(x_k)^T(x-x_k) \\
          & = \argmin_x th(x) + \/12\|x-x_k-t\nabla g(x_k)\|_2^2 - \/{t^2}2\|\nabla g(x_k)\|_2^2 \\
          & = \prox_{th}(x_k - t\nabla g(x_k)).
\end{align*}
\end{document}
