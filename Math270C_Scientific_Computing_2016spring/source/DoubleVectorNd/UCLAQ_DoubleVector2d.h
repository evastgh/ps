...
#ifndef _UCLAQ_DoubleVector2d_
#define _UCLAQ_DoubleVector2d_
...
//
        ...
        if((i < begin)||(i  > end))
        {
        cerr << "UCLAQ::DoubleVector2d index " << coordinate << " out of bounds " << endl;
    ...
    if(size1 != size2)
    {
    cerr << "UCLAQ::DoubleVector2d sizes are incompatible : " << size1 << " != " << size2;
    return false;
    }
    return true;
    }
