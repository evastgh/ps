...
#ifndef _UCLAQ_DoubleVector1d_
#define _UCLAQ_DoubleVector1d_
...
//
        ...
        if((i < begin)||(i  > end))
        {
        cerr << "UCLAQ::DoubleVector1d index " << coordinate << " out of bounds " << endl;
    ...
    if(size1 != size2)
    {
    cerr << "UCLAQ::DoubleVector1d sizes are incompatible : " << size1 << " != " << size2;
    return false;
    }
    return true;
    }
