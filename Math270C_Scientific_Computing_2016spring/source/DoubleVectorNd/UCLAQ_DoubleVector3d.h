...
#ifndef _UCLAQ_DoubleVector3d_
#define _UCLAQ_DoubleVector3d_
...
//
        ...
        if((i < begin)||(i  > end))
        {
        cerr << "UCLAQ::DoubleVector3d index " << coordinate << " out of bounds " << endl;
    ...
    if(size1 != size2)
    {
    cerr << "UCLAQ::DoubleVector3d sizes are incompatible : " << size1 << " != " << size2;
    return false;
    }
    return true;
    }
