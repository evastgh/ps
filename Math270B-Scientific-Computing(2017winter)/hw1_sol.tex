...
\usepackage{fancyhdr}\pagestyle{fancy}\rhead{Stephanie Wang}\lhead{Document Title}
...
Fix $x, y\in\R$. Assuming $x \odiv y = \fl(\fl(x)\div \fl(y))$, denote $z = \fl(x)\div \fl(y)$. We know 
