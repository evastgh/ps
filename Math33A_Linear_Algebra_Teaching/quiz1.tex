...
\usepackage{fancyhdr}\pagestyle{fancy}\rhead{April 8, 2019}\lhead{Math 33A -- Quiz 1}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{document}
\noindent1. Sketch the eight possible ways three planes can be positioned relative to each other. \\
\\
\noindent2. Solve the following two linear systems. 
\begin{equation*}
	\l\{
	\begin{array}{l}
		2x+3y=2\\
	...
	\r.
\end{equation*}
You can use any technique (row operation, substitution, extended matrix, etc.). If the system doesn't have a solution, explain why. If the system has infinitely many solution, describe the set of solutions with elaborations (e.g. parametrization).
